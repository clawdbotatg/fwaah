    ...
    if (LISTER) {
      ...
      listerOut = {
        ...
        capital: {
          ...
          fundedBy: Object.fromEntries(Object.entries(inflow).map(([a, amt]) => [a === FWA_ADDRESS.toLowerCase() ? 'pool earnings (' + a + ')' : a === pool.contracts.feeSplitter ? 'trading fees via OwnerSplitterV2 (' + a + ')' : a === v.owner.toLowerCase() ? 'owner (' + a + ')' : a, fmtEth(amt)])),
        },
